    ...
    <div x-init="setInterval(() => nextSlide(), 5000)" class="relative text-white overflow-hidden">
        <template x-for="(banner, index) in banners" :key="index">
            <div 
                ...
                class="py-16 px-4 transition-opacity duration-1000"
            >
...
<?php echo $__env->make('frontend.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/wanzie/Desktop/kedai-caruban-2/resources/views/frontend/home.blade.php ENDPATH**/ ?>