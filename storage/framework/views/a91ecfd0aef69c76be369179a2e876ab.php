...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    ...
    <form method="GET" action="<?php echo e(route('admin.reports.sales')); ?>" class="flex gap-4 items-end flex-wrap">
        ...
        <a href="<?php echo e(route('admin.reports.sales.export', ['month' => $month, 'year' => $year])); ?>" class="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition font-semibold">
            📊 Download Excel
        </a>
    </form>
</div>
