...
<div class="bg-gray-50 min-h-screen py-8">
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="mb-8 flex items-center justify-between">
            <div>
                <a href="{{ route('admin.categories') }}" class="inline-flex items-center gap-2 text-primary hover:text-primary-light font-medium mb-4">
            ...
            <div class="text-right hidden sm:block">
                <div class="bg-primary/10 rounded-lg p-4 border border-primary/20">
                    ...
                    <p class="text-3xl font-bold text-primary">{{ $category->menuItems()->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            <!-- Form Content -->
            <form action="{{ route('admin.categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="p-8 lg:p-10">
                @csrf
                @method('PUT')
                ...
                <div class="mb-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gradient-to-br from-primary/10 to-primary/5 rounded-lg p-6 border border-primary/20">
                            ...
                            <p class="text-4xl font-bold text-primary mt-2">{{ $category->menuItems()->count() }}</p>
                        ...
                        <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg p-6 border border-gray-200">
                            ...
                            <p class="text-2xl font-bold text-gray-800 mt-2">{{ $category->created_at->format('d M Y') }}</p>
                            <p class="text-xs text-gray-600 mt-2">{{ $category->created_at->format('H:i') }}</p>
                        </div>
                    </div>
                </div>
