                    ...
                    <div class="bg-gray-50 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition">
                        ...
                        <div class="p-4">
                            ...
                            <div class="text-xs text-gray-500 mb-4">
                                {{ $category->menuItems()->count() }} item menu
                            </div>

                            <!-- Tombol Aksi -->
                            <div class="flex gap-2">
                                <a href="{{ route('admin.categories.edit', $category) }}" class="flex-1 bg-primary text-white px-3 py-2 rounded-lg hover:bg-primary-light transition text-sm font-medium flex items-center justify-center gap-2">
