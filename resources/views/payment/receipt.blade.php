    ...
    <div class="bg-white rounded-xl shadow-lg max-w-md w-full p-6">
        ...
        <div class="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <div class="flex justify-between items-center mb-2">
                ...
                <span class="font-bold text-gray-800">{{ $order->table_number }}</span>
            </div>
            <div class="flex justify-between items-center mb-2">
        ...
        <div class="space-y-3">
            ...
            <a href="{{ route('home') }}" class="block w-full bg-gray-200 text-gray-800 py-3 rounded-lg font-semibold hover:bg-gray-300 transition text-center">
                Pesan Menu Lain
            </a>
        </div>
    </div>
